...
def show_income():
    ...
    #n_greater_50k = sum(data['exceeds50K'] == '>50K')

    # TODO: Number of records where individual's income is at most $50,000
    #n_at_most_50k = sum(data['exceeds50K'] == '<=50K')
    n_at_most_50k, n_greater_50k = data.exceeds50K.value_counts()
...
def evaluate():
    ...
    features_raw = data.drop('exceeds50K', axis = 1)
